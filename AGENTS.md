...
- `includes/tools/class-simple-mcp-tools-{blocks,wploc,content,describe,wc,mc,seo}.php` — tool
  modules (each exposes `defs()`; wc/mc/seo are optional — hidden unless their companion
  plugin is active).
